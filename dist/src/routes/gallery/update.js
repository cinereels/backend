...
Router.put('/api/gallery/:id', function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var id, _a, imageUrl, videoUrl, caption, type, modifiedType, gallery, err_1;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _b.trys.push([0, 3, , 4]);
                id = req.params.id;
                _a = req.body, imageUrl = _a.imageUrl, videoUrl = _a.videoUrl, caption = _a.caption, type = _a.type;
                modifiedType = gallery_type_1.GalleryType.Image;
                if (type === 'video') {
                    modifiedType = gallery_type_1.GalleryType.Video;
                }
                return [4 /*yield*/, gallery_1.Gallery.findById(id)];
            case 1:
                gallery = _b.sent();
                if (!gallery) {
