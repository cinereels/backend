...
var gallery_parent_1 = require("../../utility/gallery-parent");
var Router = express_1.default.Router();
exports.GalleryCreateRouter = Router;
var unlink = util_1.default.promisify(fs_1.default.unlink);
Router.post('/api/gallery', function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, caption, type, parent_1, url, modifiedType, imageUrl, videoUrl, isResourceUrl, file, result, file, result, gallery, err_1;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _b.trys.push([0, 9, , 10]);
                _a = req.body, caption = _a.caption, type = _a.type, parent_1 = _a.parent, url = _a.url;
            ...
            case 7:
                gallery = gallery_1.Gallery.build({
                    ...
                    videoUrl: videoUrl,
                    caption: caption,
                    type: modifiedType, parent: gallery_parent_1.GalleryParent.Channel,
