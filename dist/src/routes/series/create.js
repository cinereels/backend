...
exports.SeriesCreateRouter = void 0;
...
exports.SeriesCreateRouter = Router;
Router.post('/api/series', require_admin_1.requireAdmin, series_2.SeriesValidator, validate_request_1.validateRequest, function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, name_1, description, genre, seasons, gallery, series, notification, err_1;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _b.trys.push([0, 3, , 4]);
                _a = req.body, name_1 = _a.name, description = _a.description, genre = _a.genre, seasons = _a.seasons, gallery = _a.gallery;
                series = series_1.Series.build({
                    name: name_1,
